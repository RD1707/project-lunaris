...
const Footer = () => {
  return (
    <footer className="bg-black/30 border-t border-gray-800/50 mt-20">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            <h3 className="text-2xl font-bold text-white">Lunaris</h3>
            <p className="mt-2 text-gray-400">Desbravando as fronteiras do desconhecido.</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-white">Navegação</h4>
            <ul className="mt-4 space-y-2">
              <li><Link href="/missions" className="text-gray-400 hover:text-white transition-colors">Missões</Link></li>
              <li><Link href="/fleet" className="text-gray-400 hover:text-white transition-colors">Frota</Link></li>
              <li><Link href="/contact" className="text-gray-400 hover:text-white transition-colors">Contato</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-semibold text-white">Siga-nos</h4>
        ...
        <div className="mt-12 border-t border-gray-800/50 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} Lunaris. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
